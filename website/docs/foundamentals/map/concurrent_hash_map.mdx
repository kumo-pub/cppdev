`melon-atomic_hashmap`
----------------------

`melon-atomic_hashmap` introduces a synchronized UnorderedAssociativeContainer
...
consider using `melon::PackedSyncPtr<T>` as your `ValueT`.
...
UnorderedAssociativeContainer concept, see `melon/AtomicHashMap.h`
