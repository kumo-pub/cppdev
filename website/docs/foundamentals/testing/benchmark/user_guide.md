...
## Calculating Asymptotic Complexity (Big O) {#asymptotic-complexity}
...
## Statistics: Reporting the Mean, Median and Standard Deviation / Coefficient of variation of Repeated Benchmarks {#reporting-statistics}
...
## Using RegisterBenchmark(name, fn, args...) {#using-register-benchmark}
