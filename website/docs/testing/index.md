...
## Unit Test
### doctest
doctest is the primary testing framework used by Kumo, featuring lightweight architecture and header-only implementation. For more details, refer to the [detailed documentation](/docs/testing/gt/).
